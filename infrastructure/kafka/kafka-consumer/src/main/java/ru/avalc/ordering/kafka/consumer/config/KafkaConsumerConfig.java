package ru.avalc.ordering.kafka.consumer.config;
...
import ru.avalc.ordering.kafka.config.data.KafkaConfigData;
import ru.avalc.ordering.kafka.config.data.KafkaConsumerConfigData;
